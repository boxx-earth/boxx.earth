    ...
    <>
      ...
      <SimpleLayout 
        ...
        intro={<>
          ...
          <p className='mt-3'>日本のリサイクル・資源循環には法律や制度が重要な役割を果たしています。さらに、日本の文化や教育においては、人々のリサイクルに関する意識が高く、多くの人が関心を持っています。</p>
          <p className='mt-3'>boxxを使って資源の効率的な循環利用を促進させましょう!</p>
        </>}>
