      ...
      <Container className="mt-16 sm:mt-32">
        <div className="">
          ...
          <div className="mt-8 text-base text-zinc-600 dark:text-zinc-400">
            ...
            <h3 className="mb-2 mt-8 text-lg font-bold tracking-tight">
              1. 個人情報
            </h3>
            <p>
            ...
            <ol className="mt-3 list-inside list-decimal">
              ...
              <ol className="list-inside list-decimal p-3">
                <li>
            ...
            <div>
              <p className="mb-5">
                本プライバシーポリシー又は当社の個人情報等の取扱に関してのお問合わせ・苦情等は以下のお問合せフォームからご連絡ください。
              </p>
              <Link
                href="/contact"
                className="text-teal-500 transition hover:underline dark:text-teal-400"
              >
                &rarr; お問合せフォーム
              </Link>
            </div>
